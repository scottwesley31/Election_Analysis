...
with open(file_to_save, "w") as txt_file:
    ...
    county_results2 =(
        f'The county with the largest turnout was {winning_county} with {vote_county_count} votes and {vote_county_percent:.1f}% of the total votes.'
    )
